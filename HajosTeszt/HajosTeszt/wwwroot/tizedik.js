...
document.addEventListener("DOMContentLoaded", () => {
    ...
    //elore hatra gombok
    document.getElementById("Elore_gomb").addEventListener("click", kattElore);
    document.getElementById("Vissza_gomb").addEventListener("click", kattVissza);

    //mentett allapot olvasasa
...
function választás(n) {
    ...
    if (n === kérdés.correctAnswer) {
        ...
        if (hotList[displayedQuestion].goodAnswers === 3) {
            ...
            nextQuestion++;
            //ToDO: kerdeslista vege ellenorzes
        }
    ...
    timerHandler = setTimeout(kattElore, 3000);
